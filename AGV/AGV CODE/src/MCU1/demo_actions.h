...
private:
    ...
    // Instructions from ÖS hard Coded
    // 10% = 0x0A, 20% = 0x14, 40% = 0x28, 60% = 0x3C, 100% = 0x64
    StaticVector<Comm::Packet, 7> _instr = {
        // lyft bilen
        Comm::Packet{'D', 0, {0x00, 0x3C}, 2, 0, true}, // (45, 185) framåt
        Comm::Packet{'D', 0, {0x00, 0x3C}, 2, 0, true}, // (125, 185) framåt
        Comm::Packet{'D', 0, {0x0D, 0x3C}, 2, 0, true}, // (50, 110) rotation vänster
        Comm::Packet{'D', 0, {0x01, 0x3C}, 2, 0, true}, // (50, 250) backa
        // släpp bilen
        Comm::Packet{'D', 0, {0x00, 0x3C}, 2, 0, true}, // (50, 185) framåt
        Comm::Packet{'D', 0, {0x03, 0x3C}, 2, 0, true}, // (35, 185) vänster
        Comm::Packet{'D', 0, {0x08, 0x3C}, 2, 0, true}  // rotation höger 90grader
    };

    StaticVector<Position, 7> _instr_coords = {
        Position{45, 185},
        Position{125, 185},
        Position{125, 185},
        Position{50, 110},
    ...
    StaticVector<Comm::Packet, 50> _motion_buffert; // buffer for motion commands to be sent to MCU2, increased to 50
